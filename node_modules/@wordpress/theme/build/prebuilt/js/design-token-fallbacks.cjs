...
var design_token_fallbacks_exports = {};
__export(design_token_fallbacks_exports, {
  default: () => design_token_fallbacks_default
});
module.exports = __toCommonJS(design_token_fallbacks_exports);
...
//# sourceMappingURL=design-token-fallbacks.cjs.map
